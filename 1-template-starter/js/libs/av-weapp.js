...
function errorHandler(event) {
  // å®‰å“å°ç¨‹åºä¼šè¯¡å¼‚åœ°è§¦å‘ onSocketError å›žè°ƒ
  // é€šè¿‡æ¯”è¾ƒ message è¿‡æ»¤æŽ‰
...
var XMLHttpRequest = function (_EventTarget2) {
  ...
  _createClass(XMLHttpRequest, [{
    ...
    value: function abort() {
      // åŸºç¡€åº“ 1.4.0 å¼€å§‹æ”¯æŒ
      if (!this._request || this._request.abort) {
        this.status = 0;
        this.readyState = DONE;
        return this._request.abort();
      }
      throw new Error('è¯¥ç‰ˆæœ¬åŸºç¡€åº“ä¸æ”¯æŒ abort request');
    }
  }, {
    ...
    value: function send(data) {
      ...
      if (data instanceof FormData) {
        ...
        this._request = wx.request({
          url: this._url,
          data: data || '',
          // method çš„ value å±…ç„¶å¿…é¡»ä¸ºå¤§å†™
...
module.exports = function (AV) {
  ...
  AV.User = AV.Object.extend("_User", /** @lends AV.User.prototype */{
    ...
    associateWithAuthData: function associateWithAuthData(userObj, platform, authData) {
      console.warn('DEPRECATED: User.associateWithAuthData å·²åºŸå¼ƒï¼Œè¯·ä½¿ç”¨ User#associateWithAuthData ä»£æ›¿');
...
module.exports = {
  polyfill: function polyfill() {
    ...
    //  å‡æ‰®ä¸º React Nativeï¼Œè®© axios è®¤ä¸ºè¿™æ˜¯ä¸€ä¸ª nonStandardBrowserEnv
